...
public void draw() {
 ...
 // text("Connected to:",400,45); text(Serial.list()[1],515,65);
  //text("Connected to:",400,45); text(Serial.list()[2],515,65);
    ...
    if(PitchP.getValue()==0)PitchP.setValue(0.01f);
    if(RollP.getValue()==0)RollP.setValue(0.01f);
    if(YawP.getValue()==0)YawP.setValue(0.01f);

    if(PitchD.getValue()==0)PitchD.setValue(0.01f);
    if(RollD.getValue()==0)RollD.setValue(0.01f);
    if(YawD.getValue()==0)YawD.setValue(0.01f);
...
public void WRITE() {
  ...
  myPort.write (PApplet.parseInt (PitchP.getValue()*100));
  myPort.write (PApplet.parseInt (RollP.getValue()*100));
  myPort.write (PApplet.parseInt (YawP.getValue()*100));

  myPort.write (PApplet.parseInt (PitchD.getValue()*100));
  myPort.write (PApplet.parseInt (RollD.getValue()*100));
  myPort.write (PApplet.parseInt (YawD.getValue()*100));

  myPort.write (PApplet.parseInt (PitchPWR.getValue()));
  myPort.write (PApplet.parseInt (RollPWR.getValue()));
  myPort.write (PApplet.parseInt (YawPWR.getValue()));

  myPort.write (RCcontrol);
  myPort.write (YawRCon);

  myPort.write (PApplet.parseInt (RollCal.getValue()*10+100));
...
public void ZERO() {
  ...
  public void settings() {  size(600, 280); }
